...
eClipBord is a project with the purpose to use several techstacks to a fullstack application to deploy. The end product will be a deployed dashboard with data about lunar eclipses
